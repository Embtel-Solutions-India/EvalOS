...
- **Marketing *readings*, GM-only (Unit 26; Unit 24's Google Ads screen was removed on
  2026-09-14 — the replacement GHL sub-account has no paid-search funnel, so it could only
  ever 502)**: GHL's email marketing funnel, stage by stage — deals, value and source. Windows onto
