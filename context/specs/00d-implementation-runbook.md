...
| 3 | **Change the local config default** — `application-local.yml` — off the abandoned sub-account. **DONE 2026-09-14**; the default is `WY6bW2xUCI8Tz8gw7aLJ`, the final location. | A developer's empty screens are real emptiness, not a dead account. |
