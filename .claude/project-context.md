...
| Brevo (`POST /v3/smtp/email`) / SMTP (Spring Mail) | out | **two messages only** — set-password and reset-password. Which one carries them is `evalos.mail.transport`; prod defaults to `brevo` |
